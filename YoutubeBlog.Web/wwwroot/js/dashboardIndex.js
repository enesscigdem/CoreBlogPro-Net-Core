...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("h3#totalCategoryCount").append(data); // id olduğunu #(diez olarak anlıyoruz) class olsa idi (.) olacaktı.
        },
        error: function (data) {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (data) {
            $("h3#totalArticleCount").append(data); // id olduğunu #(diez olarak anlıyoruz) class olsa idi (.) olacaktı.
        },
        error: function (data) {
